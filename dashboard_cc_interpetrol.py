...
sql_ip_ipmt = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='77270912') AND (cwmovim.PctCod='1-1-10-005') AND (cwcpbte.CpbEst='V'))"

sql_ip_csb = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbAno>='2024') AND (cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='76722235') AND (cwmovim.PctCod='1-1-10-016') AND (cwcpbte.CpbEst='V'))"
...
import_sqlserver2gas(mydb,sql_ip_ipmt,ws,"qInterpetrol-IPMT",10)
