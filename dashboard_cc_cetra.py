...
print(datetime.now(),': CETRA ctas ctes DASHBOARD')
...
sql_cetra_carsi = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='79963530') AND (cwmovim.PctCod='1-1-10-006') AND (cwcpbte.CpbEst='V'))"
sql_cetra_conacsa = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='96981330') AND (cwmovim.PctCod='1-1-10-007') AND (cwcpbte.CpbEst='V'))"
sql_cetra_cmi = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='79826430') AND (cwmovim.PctCod='1-1-10-008') AND (cwcpbte.CpbEst='V'))"
sql_cetra_innovaplast = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='76837100') AND (cwmovim.PctCod='1-1-10-010') AND (cwcpbte.CpbEst='V'))"
sql_cetra_interpetrol = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='87827000') AND (cwmovim.PctCod='1-1-10-011') AND (cwcpbte.CpbEst='V'))"
sql_cetra_ipacifico = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='76835280') AND (cwmovim.PctCod='1-1-10-012') AND (cwcpbte.CpbEst='V'))"
sql_cetra_icetra = "SELECT cwcpbte.CpbAno, cwmovim.CodAux, cwmovim.PctCod, cwmovim.TtdCod, cwttdoc.DesDoc, cwmovim.NumDoc, cwmovim.MovFe, cwmovim.MovFv, cwmovim.MovTipDocRef, cwmovim.MovNumDocRef, cwcpbte.CpbNum, cwcpbte.CpbFec, cwmovim.MovDebe, cwmovim.MovHaber, cwmovim.MovGlosa, cwcpbte.CpbEst FROM softland.cwcpbte cwcpbte, softland.cwmovim cwmovim, softland.cwttdoc cwttdoc WHERE cwmovim.CpbAno = cwcpbte.CpbAno AND cwmovim.CpbNum = cwcpbte.CpbNum AND cwmovim.AreaCod = cwcpbte.AreaCod AND cwmovim.TtdCod = cwttdoc.CodDoc AND ((cwcpbte.CpbNum<>'00000000') AND (cwmovim.CodAux='77214176') AND (cwmovim.PctCod='1-1-10-014') AND (cwcpbte.CpbEst='V'))"
