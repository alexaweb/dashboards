...
import config.cellecapitalDB as DB
...
#BEGIN
print(datetime.now(),': Celle Capital DASHBOARD')
...
print(datetime.now(),': Celle Capital DASHBOARD: REM')
import_sqlserver2gas(mydb,sql_gastosdetalle,ws,"qGASTOSDETALLE",12)
print(datetime.now(),': Celle Capital DASHBOARD: GASTOS DETALLE')
import_sqlserver2gas(mydb,sql_ingresos,ws,"qINGRESOS",13)
print(datetime.now(),': Celle Capital DASHBOARD: INGRESOS')
import_sqlserver2gas(mydb,sql_ventas,ws,"qVENTAS",14)
print(datetime.now(),': Celle Capital DASHBOARD: VENTAS')
import_sqlserver2gas(mydb,sql_saldos,ws,"qSALDOS",15)
print(datetime.now(),': Celle Capital DASHBOARD: SALDOS')
